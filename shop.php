                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="single-shop-product">
                            ...
                            <div class="product-carousel-price">
                                <ins><?php echo $product['price'] ?></ins> <del><?php echo $product['price']+100 ?></del>
                            </div>  
                            
                            <div class="product-option-shop">
                                <a class="add_to_cart_button" data-quantity="1" data-product_sku="" data-product_id="70" rel="nofollow" href="shop.php?action=add&id=<?php echo intval($product['product_id']) ?>">Add to cart</a>
                            </div>                       
                        </div>
                    </div>
                <?php endforeach; ?>
